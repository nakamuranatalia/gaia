				...
				<div class="row justify-content-center">
					<div class="col-lg-10 text-center">
						<h3 class="text-uppercase font_black font-weight-bold">FILL
							THE FORM TO SEARCH FOR AN EXISTING RECYLIGN IDEA AND UPDATE IT</h3>
							...
							<div class="form-row">
								...
								<div class="form-group text-center">
									<label class="font_black" for="inputTitle">Title</label> <input
										...
										name="title" placeholder="Jewl box" required>
								</div>
								<div class="col-lg-12 text-center">
									<input type="hidden" name="command"
										value="UpdateIdeasSearchCommand"> <input type="submit"
