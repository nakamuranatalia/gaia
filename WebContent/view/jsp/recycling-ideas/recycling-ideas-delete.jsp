...
<body id="page-top">
    <!-- Navigation-->
    <nav class="navbar navbar-expand-lg navbar-light py-3 fixed-top bg-light animate__animated animate__fadeInDown" id="mainNav">
        <div class="container">
...
<g>
            ...
            <small class="font_black">| Delete Recipe</small>
