...
<body id="page-top">
    ...
    <section class="margin-t-93 padding-t-55 animate__animated animate__fadeIn">
        <div class="wrapper">
            <div class="container">
            	<c:forEach items="${recyclingIdeasList}" var="ideas">
	                <div class="row justify-content-center">
	                    ...
	                    <div class="row col-12 text-center">
    						...
    						<div class="col-6">
    							<h3 class="text-uppercase font_black font-weight-bold">Step by step:</h3>
    						</div>
						</div>
						<div class="row">
    						...
    						<div class="col-4 offset-1"> 
    							<p>${fn:replace(ideas.steps,newLineChar,"<br/>")}</p><br>
							</div>
						</div>
				</c:forEach>
            </div>
