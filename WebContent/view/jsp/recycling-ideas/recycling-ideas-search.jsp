...
<body id="page-top">
    <!-- Navigation-->
    <nav class="navbar navbar-expand-lg fixed-top bg-light navbar-light py-3 animate__animated animate__fadeInDown" id="mainNav">
        <div class="container">
...
<g>
            ...
            <small class="font_black">| Search Recipe</small>
