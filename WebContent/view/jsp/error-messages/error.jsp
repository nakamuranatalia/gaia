...
<g>
            ...
            <small class="font_black">| Error</small>
    ...
    <div class="container h-100 margin-t-93 padding-t-55  animate__animated animate__fadeIn">
        <div class="wrapper">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-8">
                    <h1 class="text-uppercase color_dark font-weight-bold">Your request wasn't successfull</h1>
                    <hr class="divider border_light my-4" />
                </div>
                <div class="col-4">
                    <img class="ghost" src="../../assets/img/icones/ghost-triste.png">
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="bg-footer py-5 footer">
        <div class="container">
            <div class="small text-center color_dark">Copyright © 2020 - Gaia</div>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
