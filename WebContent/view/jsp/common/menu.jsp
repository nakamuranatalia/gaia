				...
				<li class="nav-item">
					<div class="dropdown">
						...
						<div class="dropdown-menu options_dropdown" aria-labelledby="dropdownMenu2">
							<form method="get" action="/gaia/FrontController.do">
					...
					<div class="dropdown">
						...
						<div class="dropdown-menu options_dropdown" aria-labelledby="dropdownMenu2">
							<form method="get" action="/gaia/FrontController.do">
								...
								<button class="dropdown-item back_drop text-white" type="submit">
									Create Recycling Ideas
								</button>
							</form>
							<button class="dropdown-item back_drop" type="button">
								<a class="link_dropdown_button" href="/gaia/view/jsp/recycling-ideas/recycling-ideas-update.jsp">
									Update Recycling Ideas
								</a>
							</button>
							<button class="dropdown-item back_drop" type="button">
								<a class="link_dropdown_button" href="/gaia/view/jsp/recycling-ideas/recycling-ideas-delete.jsp">
