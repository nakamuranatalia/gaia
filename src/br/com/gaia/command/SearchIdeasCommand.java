...
public class SearchIdeasCommand implements Command{
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("view/jsp/recycling-ideas/recycling-ideas-search.jsp").forward(request, response);
	}
